...
def _send_new_user_welcome_notification(username, email, date_joined):
    ...
    message = (
        ...
        f'Please note: After initial registration, please allow our operations team some time to assign your customized configuration. Once the configuration is active, you will receive another notification email.\n\n'
